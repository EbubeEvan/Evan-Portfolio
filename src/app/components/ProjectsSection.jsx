...
const projectsData = [
  ...
  },
  {
    id: 2,
    title: "BeautyCare AI",
    description: "An AI-powered beauty consultation application where women can chat with a large language model that is a beauty specialist. Built with typescript, React, Next.js, Tailwindcss, Mongodb and Google Gemini. In Progress",
